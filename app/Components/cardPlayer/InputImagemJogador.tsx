...
const InputImagemJogador: React.FC<InputImagemProps> = ({
  Background,
  id,
  limparImagem,
  setlimparImagem,
  ...
  return (
    <>
      ...
      />
      <label htmlFor={`ImagemInput${id}`} className="ImageImputJogador">
        <div
          className="botaoadd"
          id={`btnAdd${id}`}
...
export default InputImagemJogador;
