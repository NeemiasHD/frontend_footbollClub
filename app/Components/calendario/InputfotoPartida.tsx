...
interface InputImagemProps {
  ...
  setImagemInput: (valor: string) => void;
}

const InputfotoPartida: React.FC<InputImagemProps> = ({
  Background,
  id,
  limparImagem,
  setlimparImagem,
  ...
  return (
    <>
      ...
      />
      <label htmlFor={`ImagemInput${id}`} className="FotoPartida">
...
export default InputfotoPartida;
