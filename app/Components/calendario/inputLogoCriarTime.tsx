...
const InputLogoCriarTime: React.FC<InputImagemProps> = ({
  Background,
  id,
  limparImagem,
  setlimparImagem,
  ...
  return (
    <>
      ...
      />
      <label htmlFor={`ImagemInput${id}`} className="ImageImputLogoTime">
...
export default InputLogoCriarTime;
