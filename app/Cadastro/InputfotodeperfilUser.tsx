...
import "./InputfotodeperfilUser.css";
...
const InputfotodeperfilUser: React.FC<InputImagemProps> = ({
  Background,
  id,
  limparImagem,
  setlimparImagem,
  ...
  return (
    <>
      ...
      <label
        ...
        title="insira sua foto de perfil"
      >
...
export default InputfotodeperfilUser;
